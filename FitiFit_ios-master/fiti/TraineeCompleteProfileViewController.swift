//
//  TraineeCompleteProfileViewController.swift
//  fiti
//
...
import UIKit
import Toucan
class TraineeCompleteProfileViewController: RespondsToKeyboardViewController {
    ...
    override func viewDidLoad() {
        ...
        nameTf.text = APIManager.shared.meTrainee?.name
        radioMLabel.text = "male".localized
        radioFLabel.text = "female".localized
        if (APIManager.shared.meTrainee?.gender=="M") {
            onMale(nil)
        } else {
            onFemale(nil)
        }
    ...
    @IBAction func onNext() {
        ...
        if let me = APIManager.shared.meTrainee {
            ...
            APIManager.shared.updateTrainee(["name":name, "gender": gender], success: {
                print("updated name")
                }) { message in
                    print(message);
            }
...
extension TraineeCompleteProfileViewController:UITextFieldDelegate {
    func textFieldShouldReturn(textField: UITextField) -> Bool {
        textField.resignFirstResponder()
        return false
    }
}
extension TraineeCompleteProfileViewController : UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    func imagePickerController(picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]) {
        if let img = info[UIImagePickerControllerEditedImage] as? UIImage, me = APIManager.shared.meTrainee {
